...
use App\Http\Requests\Developer\MessageRequest;
...
class MessageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.developer.message.received_list', ['receive_messages' => $receive_messages]);
    }
    ...
    public function sendMessages()
    {
        ...
        return view('pages.developer.message.sent_list', ['send_messages' => $send_messages]);
    }

    public function sendMessageShow($id)
    {
        $message = SendMessage::find($id);
        return view('pages.developer.message.send_show', ['message' => $message]);
    }
    ...
    public function create()
    {
        ...
        return view('pages.developer.message.create', ['users' => $users]);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.developer.message.show', ['message' => $message]);
    }
