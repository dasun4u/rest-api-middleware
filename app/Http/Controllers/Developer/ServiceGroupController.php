...
use App\Http\Requests\Developer\ServiceGroupRequest;
...
class ServiceGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.developer.service-group.list', ['groups' => $groups]);
    }
    ...
    {
        return view('pages.developer.service-group.create');
    }
    ...
    public function store(ServiceGroupRequest $request)
    {
        ...
        return redirect('developer/serviceGroups');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.developer.service-group.show', ['group' => $group]);
    }
    ...
    {
        $group = ServiceGroup::find($id);
        return view('pages.developer.service-group.edit', ['group' => $group]);
    }
