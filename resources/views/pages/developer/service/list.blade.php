    ...
    <div class="col-sm-10">
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-4 btn-div-pad">
                        <a href="{{ url('/developer/services/create') }}">
                        ...
                        <table class="table main-table">
                            ...
                            @forelse($services as $service)
                                <tr class="{{ $service->active?"success":"default" }}">
                                    ...
                                    <td>
                                        <a href="{{ url('developer/services/'.$service->id) }}">
                                    ...
                                    <td>
                                        <a href="{{ url('developer/services/'.$service->id.'/edit') }}">
        ...
        <script>
            ...
            function changeStatus(id, status) {
                $.ajax({
                    type: 'get',
                    url: '{!! url('developer/services/changeStatus/') !!}/' + id + '/' + status,
                    success: function (data) {
                        if (data["status"] == "SUCCESS") {
                            if (status == 1) {
