...
@section('content')
    <div class="col-sm-9 body-back">
        <form action="{{ url('/admin/applications') }}" method="post">
            {{ csrf_field() }}
            ...
            <div class="row min-pad">
                <div class="col-sm-6 box-wrap">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="checkbox" id="active" name="active" {{ old('active')=='on'?"checked":"" }} class="toggle-switch-active col-sm-12"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="checkbox" id="approved" name="approved" {{ old('approved')=='on'?"checked":"" }} class="toggle-switch-approve col-sm-12"
    ...
    <script>
        ...
        function generateKeys(scope) {
            ...
            $.ajax({
                type: 'get',
                url: '{!! url('admin/applications/generateKeys') !!}/' + upper_scope,
