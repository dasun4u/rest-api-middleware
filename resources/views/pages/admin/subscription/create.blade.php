...
@section('content')
    <div class="col-sm-9 body-back">
        <form action="{{ url('/admin/subscriptions') }}" method="post">
            {{ csrf_field() }}
            ...
            <div class="row min-pad">
                ...
                <div class="col-sm-6 box-wrap">
                    <div class="form-group col-sm-6">
                        <label for="approved" class="col-sm-12">Approved</label>
                        <input type="checkbox" id="approved" name="approved"
                               {{ old('approved')=='on'?"checked":"" }} class="toggle-switch-approved col-sm-12"
    ...
    <script>
        ...
        function changeServiceGroup() {
            ...
            $.ajax({
                type: 'get',
                url: '{!! url('admin/serviceGroups/getServicesByGroupID') !!}/' + group_id ,
