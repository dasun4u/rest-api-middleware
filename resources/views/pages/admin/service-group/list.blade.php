    ...
    <div class="col-sm-10">
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-4 btn-div-pad">
                        <a href="{{ url('/admin/serviceGroups/create') }}">
                        ...
                        <table class="table main-table">
                            ...
                            @forelse($groups as $group)
                                <tr class="{{ $group->active?"success":"default" }}">
                                    ...
                                    <td>
                                        <a href="{{ url('admin/serviceGroups/'.$group->id) }}">
                                    ...
                                    <td>
                                        <a href="{{ url('admin/serviceGroups/'.$group->id.'/edit') }}">
        ...
        <script>
            ...
            function deleteGroup(id) {
                $.ajax({
                    type: 'delete',
                    url: '{!! url('admin/serviceGroups') !!}/' + id,
