            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-4 btn-div-pad">
                        <a href="{{ url('/admin/messages/sendMessages/showList') }}" class="pull-left">
                            <button class="btn btn-warning pull-right">Sent messages</button>
                        </a>
                        <a href="{{ url('/admin/messages/create') }}" class="pull-right">
                            ...
                            @forelse($receive_messages as $receive_message)
                                <tr class="{{ $receive_message->is_read?"warning":"default" }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('admin/messages/'.$receive_message->id) }}">
